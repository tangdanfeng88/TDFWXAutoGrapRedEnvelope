...
@class WCRedEnvelopesReceiveHomeView; @class WCRedEnvelopesLogicMgr; @class MMServiceCenter; @class WCRedEnvelopesReceiveControlLogic; @class WCBizUtil; @class NSMutableDictionary; @class BaseMsgContentViewController; @class CContactMgr; @class CMessageMgr; 
...
#line 17 "/Users/tangdanfeng/Documents/iOS/TDFWXAutoGrapRedEnvelope/TDFWXAutoGrapRedEnvelopeDylib/AutoGrabRedEnvelops.xm"
...
static void _logos_method$_ungrouped$WCRedEnvelopesLogicMgr$OnWCToHongbaoCommonResponse$Request$(_LOGOS_SELF_TYPE_NORMAL WCRedEnvelopesLogicMgr* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, HongBaoRes * arg1, id arg2) {
    ...
    if (arg1 && arg2 && arg1.cgiCmdid==3 && [responseDict[@"receiveStatus"] integerValue]==0) {
        ...
        if (param && timingIdentifier && param[@"timingIdentifier"]) {
            ...
            if ([TDFDefaults valueForKey:TDFTIMEKEY]) {
...
#line 214 "/Users/tangdanfeng/Documents/iOS/TDFWXAutoGrapRedEnvelope/TDFWXAutoGrapRedEnvelopeDylib/AutoGrabRedEnvelops.xm"
